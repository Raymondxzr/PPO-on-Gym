...
def update(agent, optimizer, states, actions, log_probs, returns, advantages, epsilon_clip, update_epochs, step):
...
def ppo(env, num_episodes, gamma, epsilon_clip, update_epochs, learning_rate,episode_rewards):
    ...
    while episode < num_episodes:
        ...
        update(agent, optimizer, states, actions, log_probs, returns, advantages, epsilon_clip, update_epochs, step)
        episode += 1
...
if __name__ == "__main__":
    ...
    ppo(env, 128, 0.99, 0.1, 4, 5e-4, episode_rewards)
